...
class _UserHomeState extends State<UserHome> {
  ...
  Future CustomerData() async {
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        listModel = ListModel.fromJson(data2);
        circular = false;
      });
    } else {
      throw Exception("Failed to load data!");
    }
    print(listModel.records[1].fields.user_address);
  }
                      ...
                      child: Card(
                        ...
                        child: ListTile(
                          title: new Text(listModel
                                  ...
                                  .toString() +
                              '                         ' +
                              listModel.records[index].fields.user_name +
                              '                       ' +
                              (listModel.records[index].fields.product_ordered
                                          .length -
                                      1)
                                  .toString() +
                              '          ' +
                              listModel.records[index].fields.delivery_status),
                        ),
                      ),
                    );
                  },
